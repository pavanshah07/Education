...
<body style="background-color: beige; background: url('images/download.jpeg'); background-repeat: no-repeat; background-size: cover;" > 
    ...
    <div class="container">
        ...
        <form action="" method="post">
          ...
          <center><button class="btn btn-sm" style="border: 3px solid red;background-color: currentColor;"><b><a href="Admin.php">Admin Login</a></b></button></center>
          <div>
          <a href="forgot.php">Forgot password!</a>
          <a href="register.php" style="margin-left: 178px;">New user!</a>
          </div>
